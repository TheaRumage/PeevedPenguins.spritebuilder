...
//  PeevedPenguins
//
//  Created by Thea Jensvold-Rumage on 6/28/15.
...
class Gameplay: CCNode, CCPhysicsCollisionDelegate
{
    ...
    // Touch joint responder variables
    ...
    func didLoadFromCCB()
    {
        ...
        // Nothing collides with catapult arm
        pullbackNode.physicsBody.collisionMask = []
        
        // Nothing collides with invisible node for user finger
    ...
    func launchPenguin()
    {
        ...
        let force = ccpMult(launchDirection, 250)
        penguin.physicsBody.applyForce(force)
        
        // Following content node
    ...
    // Releases catapult with release of finger
